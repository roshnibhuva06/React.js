        ...
        <div>
            ...
            <div>
                <form action="" className="form" onSubmit={formik.handleSubmit}>
                    ...
                    <select className="Select" name="profession" value={formik.values.profession} id="" onChange={formik.handleChange}>
...
// const StudentFormSchema = object({
//     Name: string().required("Name must be filled"),
//     Email: string().email("Invalid email formate").required("Email must be filled"),
//     Password: number().integer().min(8, "Password must be at least 8 characters").required("Password must be filled"),
//     profession: string().required("Must Select your profession"),
//     Gender: string().required("Must Select your gender"),
// })
...
//                     <input type="Password" className="password" value={formik.values.Password} name="Password" onChange={formik.handleChange} placeholder="Password" />
//                     {formik.touched.Password && formik.errors.Password && <p> {formik.errors.Password}</p>}
//                     <select className="Select" name="SelectGrade" value={formik.values.SelectGrade} id="" onChange={formik.handleChange}>
